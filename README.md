...
برای مثال کلاس `DoorFactory` زمانی استفاده میشه که نیاز به درب چوبی داریم و کارش اینه که برای ایجاد ابجکت درب از کلاس `WoodenDoor` و برای ایجاد ابجکت متخصص از `Carpenter` استفاده کنه.

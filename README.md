...
فرض کن رفتی رستوران و فقط یه «سالاد فصل» می‌خوای. اما رستوران فقط یه منوی غول‌آسا داره به اسم «سوپر منو» که توش پیتزا، کباب، سوشی و سالاد هست. گارسون مجبورتون می‌کنه کل این منوی سنگین رو دستت بگیری و ورق بزنی تا برسی به سالاد.
...
فرض کن رفتی سفر خارج (مثلاً آمریکا). لپ‌تاپتون شارژش تموم شده و می‌خوای بزنی به برق.
اما ای داد بیداد! 😱 پریزهای اونجا سه شاخه‌ست، ولی شارژر تو دو شاخه‌ست.

شارژر تو (کلاینت) نمی‌تونه مستقیم وارد پریز (سرویس) بشه.
اینجا چیکار می‌کنی؟ سیم شارژر رو می‌برید؟ دیوار رو خراب می‌کنی؟ نه!
می‌رید یه **«مبدل» (Adapter)** می‌خرید. مبدل یه سرش به شارژر تو می‌خوره، سر دیگه‌ش به پریز دیوار.
...
تو مستقیم نمی‌رید با خودِ در کلنجار برید؛ اول رمز می‌زنی یا کارت می‌کشید.
...
فرض کن توی یه سایت کاریابی ثبت‌نام کردی و می‌گید: «هر وقت توی دسته‌ی برنامه‌نویسی، یه شغل جدید اومد، به من خبر بده.»
...
یعنی تو لازم نیست هر روز برید سایت رو چک کنی. خودِ سیستم با هر تغییر، خبرتون می‌کنه. 🔔
...
تو نمی‌خوای کل برنامه‌تون رو به `if/else`‌های طولانی تبدیل کنی که هر بار یکی گفت «روش جدید هم اضافه کن»، همه‌جا رو دستکاری کنی.
...
- این ریپو رو برای دوستاتون بفرستی!

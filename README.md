...
<div align="center">
🔋 <b>مثال دنیای واقعی: باتری کنترل تلویزیون</b>
</div>

کنترل تلویزیون شما با باتری قلمی (AA) کار می‌کنه. مهم نیست این باتری برندش "دوراسل" باشه یا "پارس". تا وقتی که سایرش AA هست و ولتاژش درسته، کنترل باید کار کنه.
حالا فرض کنید یه باتری AA بخرید که به جای ۱.۵ ولت، ۲۰ ولت برق بده! کنترل می‌سوزه. این باتری با اینکه اسمش باتری AA هست، اما "اصل جایگزینی" رو نقض کرده.
...
لامپ اتاق شما مستقیم به سیم‌های توی دیتابیس... ببخشید، سیم‌های توی دیوار لحیم نشده!
چرا؟ چون اگه بخواید لامپ رو عوض کنید و سشوار بزنید، باید دیوار رو خراب کنید.
به جاش، پریز برق یک "استاندارد" (Interface) هست. لامپ به پریز وصل میشه، سشوار هم به پریز. هیچکدوم کاری ندارن که پشت پریز برق از نیروگاه هسته‌ای میاد یا موتور برق همسایه.
